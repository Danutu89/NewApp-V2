...
--
-- Name: conversation; Type: TABLE; Schema: public; Owner: danutu
--
...
ALTER TABLE public.conversation OWNER TO danutu;

--
-- Name: conversation_id_seq; Type: SEQUENCE; Schema: public; Owner: danutu
--
...
ALTER TABLE public.conversation_id_seq OWNER TO danutu;

--
-- Name: conversations; Type: TABLE; Schema: public; Owner: danutu
--
...
ALTER TABLE public.conversations OWNER TO danutu;

--
-- Name: conversations_id_seq; Type: SEQUENCE; Schema: public; Owner: danutu
--
...
ALTER TABLE public.conversations_id_seq OWNER TO danutu;
...
--
-- Data for Name: conversation; Type: TABLE DATA; Schema: public; Owner: danutu
--

COPY public.conversation (id, members, seen, last_message_on, last_message_id) FROM stdin;
1	{4,2}	t	2020-05-25	\N
\.


--
-- Data for Name: conversations; Type: TABLE DATA; Schema: public; Owner: danutu
--

COPY public.conversations (id, message, "user", created_on, conversation_id) FROM stdin;
1	salut daniele	2	2020-05-26 00:00:00	1
2	salut ioane	2	2020-05-26 12:50:14.714651	1
3	cf boss	2	2020-05-27 11:13:33.600553	1
4	ggg	2	2020-05-27 12:07:21.434203	1
5	ggg	2	2020-05-27 12:08:03.382401	1
\.
...
19	2	danutu unliked your post	Spy on the DOM	/post/Spy-on-the-DOM-97?notification_id=19	2	t	2020-04-11 17:36:55.226568	unlike
22	2	danutu liked your post	How to iterate through a specific key-value pair in array	/post/How-to-iterate-through-a-specific-key-value-pair-in-array-75?notification_id=22	2	t	2020-04-11 17:37:04.420734	like
21	2	danutu unliked your post	How to iterate through a specific key-value pair in array	/post/How-to-iterate-through-a-specific-key-value-pair-in-array-75?notification_id=21	2	t	2020-04-11 17:37:01.32051	unlike
20	2	danutu liked your post	Spy on the DOM	/post/Spy-on-the-DOM-97?notification_id=20	2	t	2020-04-11 17:36:58.142838	like
53	4	daniel liked your post	 Tips for a Junior Dev	/post/-Tips-for-a-Junior-Dev-121?notification_id=53	2	t	2020-05-22 15:37:47.818595	like
54	4	daniel unliked your post	Django search form for filtering	/post/Django-search-form-for-filtering-16?notification_id=54	2	t	2020-05-22 15:39:10.602923	unlike
47	4	daniel unliked your post	How we can overcome distractions and stay focused as developers	/post/How-we-can-overcome-distractions-and-stay-focused-as-developers-155?notification_id=47	2	t	2020-05-22 13:06:13.861036	unlike
46	4	daniel liked your post	How we can overcome distractions and stay focused as developers	/post/How-we-can-overcome-distractions-and-stay-focused-as-developers-155?notification_id=46	2	t	2020-05-22 13:01:04.311837	like
...
56	2	danutu unliked your post	 Tips for a Junior Dev	/post/-Tips-for-a-Junior-Dev-121?notification_id=56	2	t	2020-05-23 14:06:50.861489	unlike
57	2	danutu liked your post	 Tips for a Junior Dev	/post/-Tips-for-a-Junior-Dev-121?notification_id=57	2	t	2020-05-23 14:08:15.027607	like
\.
...
2	2019-07-20	danutu	Daniel Ionut	danutu@newapp.nl	$2b$12$kZ1VTFKIwidOiH31fWbJX.rOZuUDQsbCJ8J3B9.6ptn.mQZJ11m0m	/static/profile_pics/user_2.webp	Female	10	The website Developer	t	151.76.192.171	Chrome	Italy	it	it	{opensource,beginners,javascript,css,flask,python,svelte}	2001-09-29	Junior Web Developer	{93,16,13}	{13,79,85,91,15,95,126,170,93,119,16,1,14,194,189,115,97,75,176,121,155}	{7,19,20,5,4,25,8,11,6}	{7,5,8,6,11,19,4}	https://newapp.nl/static/profile_cover/user_2.webp	daniel9ionut	danutu89	Danutu89	Danutu89	https://newapp.nl	Dark	{}	#cc1616	Offline	manual	\N
4	2019-09-06	daniel	Dan Ioan	dany89ytro@gmail.com	$2b$12$Oc7Wkm0nm/Phu0UDPknoDuuJbidfJiemYaWmumduUpjt2RLCsX6BS	https://www.component-creator.com/images/testimonials/defaultuser.png	Male	0	Hey i`m new here	t	151.76.194.180	Chrome	Italy	it	it	{javascript}	\N	None	{}	{1,75,97,121}	{2}	{2}	\N						Light	{}	#00c413	Online	system	\N
\.
...
--
-- Name: conversation_id_seq; Type: SEQUENCE SET; Schema: public; Owner: danutu
--
...
--
-- Name: conversations_id_seq; Type: SEQUENCE SET; Schema: public; Owner: danutu
--
...
--
-- Name: conversation conversation_pkey; Type: CONSTRAINT; Schema: public; Owner: danutu
--
...
--
-- Name: conversations conversations_pkey; Type: CONSTRAINT; Schema: public; Owner: danutu
--
...
--
-- Name: conversation conversation_last_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danutu
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT conversation_last_message_id_fkey FOREIGN KEY (last_message_id) REFERENCES public.conversations(id);


--
-- Name: conversations conversations_conversation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danutu
--

ALTER TABLE ONLY public.conversations
    ADD CONSTRAINT conversations_conversation_id_fkey FOREIGN KEY (conversation_id) REFERENCES public.conversation(id);


--
-- Name: conversations conversations_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: danutu
--

ALTER TABLE ONLY public.conversations
    ADD CONSTRAINT conversations_user_fkey FOREIGN KEY ("user") REFERENCES public.users(id);
