	...
	<div class="post">
		<div class="content-post" style="padding:0.8rem;">
			<div class="info" style="display:flex;">
				<div
					class="loading"
					style="margin-top: 0;margin-bottom: 1rem;width: 80%;height: 2rem;" />
			</div>
			<div class="post-author">
				<div
					class="loading"
					style="border-radius:50px;margin-right: 5px;height: 40px;width: 40px;" />
				<div class="author-info">
					<div
						class="author-name loading"
						style="width: 10rem; height: 1rem;" />
					<div class="post-tags" />
				</div>
			</div>
			<div class="post_content" style="margin-top: 1.5rem;">
				<div class="loading" style="width: 90%; height: 1rem;" />
				<br />
				<div class="loading" style="width: 80%; height: 1rem;" />
				<br />
				<div class="loading" style="width: 75%; height: 1rem;" />
				<br />
				<div class="loading" style="width: 80%; height: 1rem;" />
				<br />
				<div class="loading" style="width: 90%; height: 1rem;" />
			...
			<div class="user-actions-info">
				<span>
					<span id="hearts">
						<div class="loading" style="width: 2rem;heigth: 0.7rem;" />
					</span>
					Likes
				</span>
			</div>
