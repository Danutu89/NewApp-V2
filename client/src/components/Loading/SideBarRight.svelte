	...
	{:else if page == 'post'}
		...
		<div class="user-card" style="align-items: unset">
			<a
				...
				<div class="user-info">
					<span style="display: flex;height:0.92em;margin-bottom: 0.5rem;">
						<div class="loading" style="width:5rem;height:1rem;" />
						<span
							class="dot_status"
					...
					<span class="user-tag">
						<div class="loading" style="width:3rem;height:0.7rem;" />
					</span>
				</div>
			</a>
		...
		<div class="widget">
			<div class="widget-header">
				<div class="widget-title">
					<div class="loading" style="width: 5rem; height: 0.8rem;" />
				</div>
			</div>
			<div class="widget-list">
				...
				<div class="widget-item">
					<div class="text">
						<div class="loading" style="width: 60%; height: 0.8rem;" />
					</div>
				</div>

				<div class="widget-item">
					<div class="text">
						<div class="loading" style="width: 40%; height: 0.8rem;" />
					</div>
				</div>
				<div class="widget-item">
					<div class="text">
						<div class="loading" style="width: 70%; height: 0.8rem;" />
					</div>
				</div>
			</div>
		</div>
		<div class="widget-posts">
			<div class="widget-header" style="border:none;">
				<div class="widget-title">
					<div class="loading" style="width: 10rem; height: 0.8rem;" />
				</div>
			</div>
						...
						<div class="post-footer" style="margin-left: 2%;">
							<div class="post-title">
								<a rel="prefetch" href="/post/">
									<div
										class="loading post-title"
										style="width: 10rem; height: 1rem;" />
								</a>
							</div>
							<div class="post-tags" style="display: flex;margin-top: 0.4rem;">

								<div class="loading" style="width: 2rem; height: 0.8rem;" />
								<div class="loading" style="width: 3rem; height: 0.8rem;" />
