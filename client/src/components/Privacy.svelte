<privacy>
	<h1>Privacy Policy for NewApp</h1>

	<p>
		At NewApp, accessible from
		<a href=" https://newapp.nl">https://newapp.nl</a>
	...
	<p>
		NewApp follows a standard procedure of using log files. These files log
	...
	<p>
		Like any other website, NewApp uses 'cookies'. These cookies are used to
	...
	<p>
		...
		advertising partners of NewApp. Our Privacy Policy was created with the help
		of the
	...
	<p>
		...
		and links that appear on NewApp, which are sent directly to users' browser.
	...
	<p>
		Note that NewApp has no access to or control over these cookies that are
	...
	<p>
		NewApp's Privacy Policy does not apply to other advertisers or websites.
	...
	<p>
		NewApp does not knowingly collect any Personal Identifiable Information from
	...
	<p>
		...
		and/or collect in NewApp. This policy is not applicable to any information
